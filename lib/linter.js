...
function getEnv(slots, envId) {
    return (
        (slots.lastConfigArray && slots.lastConfigArray.getPluginEnvironment(envId)) ||
...
function getRule(slots, ruleId) {
    return (
        (slots.lastConfigArray && slots.lastConfigArray.getPluginRule(ruleId)) ||
...
class Linter {
    ...
    _verifyWithConfigArray(text, configArray, providedOptions) {
        ...
        // Apply processor.
        if (config.processor) {
            const processor = configArray.getPluginProcessor(config.processor);
     ...
     */
    getRules() {
        return internalSlotsMap.get(this).ruleMap.getAllLoadedRules();
    }
