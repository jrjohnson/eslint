...
class ConfigArray extends Array {
     ...
     * @param {string} id The env ID to get.
     * @returns {Object|null} The env definition.
     */
    getPluginEnvironment(id) {
        return ensurePluginMemberMaps(this).envMap.get(id) || null;
    }

    /**
     * Get the plugin processor definition with a given ID.
     * @param {string} id The processor ID to get.
     * @returns {Object|null} The processor definition.
     */
    getPluginProcessor(id) {
        return ensurePluginMemberMaps(this).processorMap.get(id) || null;
    }
     ...
     */
    getPluginRule(id) {
        return ensurePluginMemberMaps(this).ruleMap.get(id) || null;
    }
